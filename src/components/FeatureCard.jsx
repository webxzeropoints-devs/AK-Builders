...
const FeatureCard = ({
  title = "Architecture &\nDesign",
  badgeTitle = "Certified Quality",
  badgeSubtitle = "Precision Construction",
  icons = ['drafting', 'compass'],
  comment = "AK BUILDERS delivered beyond our expectations with exceptional attention to detail and craftsmanship.",
    ...
    <div className={`relative z-20 w-full px-4 max-w-4xl mx-auto -mt-16 lg:-mt-20 ${className}`}>
      ...
      >
        <motion.div
          ...
          className="bg-[#FAF7F0] rounded-2xl md:rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] border border-[#DED4C1] p-8 lg:p-10"
        >
          {/* Top Header Row */}
